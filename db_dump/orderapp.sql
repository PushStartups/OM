...
--
-- Host: localhost
-- Generation Time: Feb 06, 2017 at 06:57 AM
...
(1, 2, 'Angus Burger', 'אנגוס בורגר', '"Angus Burger\n250 grams of quality entrecote beef with mayonnaise, mustard, barbecue, lettuce, onions, fried onions, pickles and tomatoes."', '"אנגוס בורגר\n250 גרם בשר אנטריקוט איכותי.  בתוספת מיונז, חרדל, ברביקיו, חסה, בצל, בצל מטוגן, מלפפון חמוץ ועגבניה.\nתוספות בתשלום לבחירה: פורטובלו 4 ₪ | ביצה 4 ₪ | 50 גר'' חזה אווז 8 ₪"', 40, '/webclient/img/angus_items/angus_burger.png', 100),
(2, 3, 'Angus Tortilla', 'טורטיה אנגוס', 'Angus Tortilla: 150 grams of quality Angus entrecote beef with mayonnaise, mustard, chimichurri, lettuce and tomato.', '"טורטיה אנגוס\n150 גרם נתחי אנטריקוט אנגוס איכותיים. בתוספת מיונז, חרדל, צ''ימיצ''ורי, חסה ועגבניה.\nתוספות בתשלום לבחירה: פורטובלו 4 ₪ | ביצה 4 ₪"', 36, '/webclient/img/angus_items/tortilla.png', 101),
(3, 3, 'Pargit Tortilla', 'טורטיה פרגית', '"Spring Chicken Tortilla: \n150 grams of chicken marinated in Moroccan spices with mayonnaise, mustard, chimichurri, lettuce and tomato."', '"טורטיה פרגית\n150 גרם פרגיות במרינדה של תבלינים מרוקאים.  בתוספת מיונז, חרדל, צ''ימיצ''ורי, חסה ועגבניה.\nתוספות בתשלום לבחירה: פורטובלו 4 ₪ | ביצה 4 ₪"', 34, 'http://dev.bot2.orderapp.com/webclient/restapi/images/test.png', 102),
(4, 3, 'Chicken Tortilla', 'טורטיה עוף', '"Chicken Tortilla\n150 grams of chicken in honey sauce marunade with mayonnaise, mustard, chipotle pepper, lettuce and tomato.\n"', '"טורטיה עוף\n150 גרם נתחי חזה עוף במרינדת דבש.  בתוספת מיונז, חרדל, צ''יפוטלה, חסה ועגבניה.\nתוספות בתשלום לבחירה: פורטובלו 4 ₪ | ביצה 4 ₪"', 32, 'http://dev.bot2.orderapp.com/webclient/restapi/images/test.png', 103),
(5, 1, 'Angus Salad', 'סלט אנגוס', '"Angus salad\n150 gram entrecote/spring chicken/goose breast.\nLettuce, baby greens, tomatoes, sacks, onion and mushrooms. Served with bread, chimmichuri,  and plenty of sauces to choose from."', '"סלט אנגוס\n150 גרם נתחי אנטריקוט | פרגית | חזה אווז.\nעלי חסה, עלי בייבי, עגבניות שקי, בצל סגול ופטריות. מוגש בתוספת לחם צי''מיצ''ורי ורטבים לבחירה. \nתוספות בתשלום לבחירה: 150 גרם חזה אווז או אטנריקוט 19 ₪ | 80 גר'' כבד אווז 30 ₪"', 44, '/webclient/img/angus_items/angus_salad.png', 104),
(6, 1, 'Chicken Salad', 'סלט עוף', '"Chicken Salad\n170 grams of sweet chicken breast. Chopped lettuce, mesculin, cucumber, cherry tomatoes, red onion and mushrooms. Served with garlic bread and sauces."', '"סלט עוף\n170 גרם חזה חות מתוק. עלי חסה קצוצים, עלי בייבי, רצועות מלפפון, עגבניות שרי, בצל סגול ופטריות. מוגש בתוספת לחם שום ורטבים.\nתוספות בתשלום לבחירה: פורטובלו 4 ₪ | ביצה 4 ₪ | 170 גר'' חזה עוף 18 ₪"', 42, '/webclient/img/angus_items/chicken_salad.png', 105),
(7, 6, 'Angus Sandwich', 'אנגוס סנדוויץ', 'Angus Sandwich: 150 grams of quality Angus entrecote meat with mustard, chimichuri, lettuce, and tomatoes', '"סנדוויץ'' אנגוס\n150 גרם נתחי אנטריקוט אנגוס איכותיים. בתוספת חרדל, צ''ימיצ''ורי , חסה ועגבניה.\nתוספות בתשלום לבחירה: 50 גר'' חזה אווז 8 ₪ | 150 גר'' חזה אווז או אנטריקוט 19 ₪ | ביצה 4 ₪ | פורטובלו 4 ₪"', 37, 'http://dev.bot2.orderapp.com/webclient/restapi/images/test.png', 106),
(8, 6, 'Double angus sandwich', 'דאבל אנגוס סנדוויץ', 'Double Angus Sandwich: 300 grams of quality Angus entrecote meat with mayonaise, mustard, chimichuri, lettuce, and tomatoes ', '"סנדוויץ'' דאבל אנגוס\n300 גרם נתחי אנטריקוט אנגוס איכותיים. בתוספת מיונז, חרדל, צ''ימיצ''ורי , חסה ועגבניה.\nתוספות בתשלום לבחירה: 50 גר'' חזה אווז 8 ₪  | ביצה 4 ₪ | פורטובלו 4 ₪\n"', 56, 'http://dev.bot2.orderapp.com/webclient/restapi/images/test.png', 107),
(9, 6, 'King angus sandwich', 'קינג אנגוס סנדוויץ', 'King Angus Sandwich: 150 grams of quality Angus entrecote meat and 80 grams of goose liver with mayonaise, mustard, chimichuri, lettuce, and tomatoes ', '"סנדוויץ'' קינג אנגוס\n150 גרם נתחי אנטריקוט + 80 גר'' כבד אווז. בתוספת מיונז, חרדל, צ''ימיצ''ורי , חסה ועגבניה.\nתוספות בתשלום לבחירה: 50 גר'' חזה אווז 8 ₪  | ביצה 4 ₪ | פורטובלו 4 ₪"', 67, 'http://dev.bot2.orderapp.com/webclient/restapi/images/test.png', 108),
(10, 6, 'chicken sandwich', 'סנדוויץ עוף', 'Chicken Sandwich: 170 grams of sweet chicken breast with mayonaise, sweet chilli sauce, garlic, lettuce, and tomatoes.', '"סנדוויץ'' עוף\n170 גרם חזה עוף מתוק.  בתוספת מיונז, צ''ילי מתוק, שום, חסה ועגבניה.\nתוספות בתשלום לבחירה: 170 גר'' חזה עוף 18 ₪ | פורטובלו 4 ₪"', 33, '/webclient/img/angus_items/chicken_sandwich.png', 109),
(11, 6, 'mallard sandwich', 'סנדוויץ'' מולארד', 'Mallard Sandwich: 150 grams of quality goose breast with mayonaise, mustard, chimichuri, lettuce, and tomatoes ', '"סנדוויץ'' מולארד\n150 גר'' נתחי חזה אווז איכותיים.  בתוספת מיונז, חרדל, צ''ימיצ''ורי, חסה ועגבניה.\nתוספות בתשלום לבחירה: 50 גר'' חזה אווז 8 ₪ | ביצה 4 ₪ | פורטובלו 4 ₪"', 37, 'http://dev.bot2.orderapp.com/webclient/restapi/images/test.png', 110),
(12, 6, 'mediterranean sandwich', 'סנדוויץ ים תיכוני', 'Mediterranean Sandwich: 150 grams spring chicken with our special home made spice blend. Comes with mayonaise, tehina, spicy chilli sauce, lettuce, and tomatoes', '"סנדוויץ'' ים תיכוני\n150 גר'' פרגיות בתיבול הבית.  בתוספת מיונז, טחינה, צ''ילי חריף, חסה ועגבניה.\nתוספות בתשלום לבחירה:  פורטובלו 4 ₪"', 35, 'http://dev.bot2.orderapp.com/webclient/restapi/images/test.png', 111),
(13, 6, 'Vegetarian sandwich', 'סנדוויץ'' צמחוני', 'Vegetarian Sandwich: Mesclun leaves, red onion, tomatoes, portobello mushroom, lettuce, onion rings, and a fried egg.', '"סנדוויץ'' צמחוני\nעלי בייבי, בצל סגול, עגבניות, פורטובלו, חסה, טבעות בצל, ביצת עין ועגבניות טריות.\nרטבים לבחירה: מיונז|  פסטו | ברביקיו | צ''ילי מתוק\n"', 33, 'http://dev.bot2.orderapp.com/webclient/restapi/images/test.png', 112),
(14, 5, 'Coca Cola Zero', 'קוקה קולה', '', '', 8, '/webclient/img/drinks/download.png', 113),
(15, 5, 'Fuze Tea', 'פיוז טה', '', '', 8, '/webclient/img/drinks/CC063.png', 114),
(16, 5, 'Prigat Grape', 'פריגת ענבים', '', '', 8, '/webclient/img/drinks/Prigan_grapefruit.png', 115),
(17, 5, 'Coca Cola Zero', 'קוקה קולה זירו', '', '', 8, '/webclient/img/drinks/download.png', 116),
(18, 5, 'Diet Coke', 'דייט קוקה קולה', '', '', 8, '/webclient/img/drinks/coca-cola-diet-1-75-litre.png', 117),
(19, 5, 'Fanta', 'פנטה', '', '', 12, '/webclient/img/drinks/download (1).png', 118),
(20, 5, 'Large Coca Cola', 'בקבוק קוקה קולה גדול', '', '', 12, '/webclient/img/drinks/PDP_Coca-Cola-HFCS-1.25-Liter-Bottle.png', 119),
(21, 5, 'Large Coca Cola Zero', 'בקבוק פיוז טה גדול', '', '', 12, '/webclient/img/drinks/download.png', 120),
(22, 4, 'Small Sweet potato fries', 'צ''יפס בטטה- קטן\n', '', '', 14, '/webclient/img/angus_items/sweet_potato_fries.png', 121),
(23, 4, 'American fries', 'צ''יפס אמריקאי', '', '', 14, '/webclient/img/angus_items/american_fries.png', 122),
(24, 4, 'onion rings', 'טבעות בצל', '', '', 14, 'http://dev.bot2.orderapp.com/webclient/restapi/images/test.png', 123),
(25, 4, 'Mexican nachos', 'נאצ''וס מקסיקני מטוגן', '', '', 12, 'http://dev.bot2.orderapp.com/webclient/restapi/images/test.png', 124),
(26, 4, 'crispy chicken wings', 'כנפי עוף קריספיות ברוטב', '', '', 25, 'http://dev.bot2.orderapp.com/webclient/restapi/images/test.png', 125),
(27, 4, 'Large Sweet Potato fries', 'צ''יפס בטטה- גדול', '', '', 25, 'http://dev.bot2.orderapp.com/webclient/restapi/images/test.png', 126),
(28, 7, 'XL Pie', 'XL פאי', '', '', 56, '/webclient/img/mesh_items/XL_pie.png', 127),
(29, 7, 'XL + Toppings', 'XL + תוספות', '', '', 75, '/webclient/img/mesh_items/XL_toppings.png', 128),
(30, 7, 'Meshulashim Pie', 'פאי משלושים', 'Tomato sauce, mozzarella, garlic confit, sun-dried tomatoes and spicy peppers', 'רוטב עגבניות, מוצרלה, שום קונפי, עגבניות מיובשות ופלפלים חריפים', 32, '/webclient/img/mesh_items/meshulashim_pie.png', 129),
(31, 7, 'Margarita', 'מרגריטה', 'Tomato sauce, mozzarella, basil and olive oil', 'רוטב עגבניות, מוצרלה, בזיליקום ושמן זית', 28, '/webclient/img/mesh_items/margarita.png', 130),
(32, 7, 'Gluten Free', 'ללא גלוטן', 'Tomato sauce, mozzarella and olive oil', 'רוטב עגבניות, מוצרלה ושמן זית', 35, '/webclient/img/mesh_items/gluten_free.png', 131),
(33, 8, 'Meshulashim Toast', 'משולשים טוסט', 'Bagel toasted with Bulgarian spread and mozzarella, tomatoes, Kalamata olives, Za''atar and olive oil', 'בייגל פתוח, בולגרית למריחה מוצרלה, עגבנייה, זיתי קלמטה, זעתר ושמן זית', 25, '/webclient/img/mesh_items/meshulashim_toast.png', 132),
(34, 8, 'Bagel Toast', 'בייגל טוסט', 'Bagel with tomato sauce, mozzarella, basil and olive oil, served with 2 toppings of your choice', 'רוטב עגבניות, מוצרלה, בזיליקום ושמן זית מוגש עם שתי תוספות לבחירה', 25, '/webclient/img/mesh_items/bagel_toast.png', 133),
(35, 8, 'Crispy Capricci', 'קריספי קפרזה', 'Oven baked foccaccia with cherry tomatoes, Kalamata olives, feta cheese, basil, oregano and olive oil', 'פוקצ''ה עשיה בתנור לבנים, עגבניות שרי, זיתי קלמטה, גבינת פטה, בזיליקום, אורוגולה ושמן זית', 25, '/webclient/img/mesh_items/crispy_capricci.png', 134),
(36, 9, 'Meshulashim Salad', 'סלט משולשים', 'Selection of market vegetables, olive oil and lemon, bulgarian cheese', 'מבחר ירקות השוק, שמן זית לימון וגבינה בולגרית', 28, '/webclient/img/mesh_items/meshulashim_salad.png', 135),
(37, 9, 'Tuna Salad', 'סלט טונה', 'Mixed leaves, cherry tomatoes, cucumbers, peppers, purple onion, hard-boiled egg, seasoned tuna, lemon and olive oil', 'שלל עלים, עגבניות שרי, מלפפון, פלפלים, בצל סגול, ביצה קשה וטונה מתובלים בלימון ושמן זית', 28, '/webclient/img/mesh_items/tuna_salad.png', 136),
(38, 9, 'Greek Salad', 'סלט יווני', 'Cucumbers and chopped tomatoes on a bed of lettuce, feta cheese, red onion, roasted peppers, Kalamata olives, za''atar, lemon and olive oil', '"מלפפון ועגבניות קצוצים על מצע חסות, פטה מגורדת,\nבצל סגול, פלפל קלוי, זיתי קלמטה, זעתר, לימון ושמן זית"', 28, '/webclient/img/mesh_items/greek_salad.png', 137),
(39, 10, 'Meshulashim Pasta', 'משולשים פסטה', 'Stir-fried mushrooms, onion and sun-dried tomatoes with herbs, garlic and olive oil', 'פטריות בצל ועגבניות מיובשות מוקפצים בעשבי תיבול שום ושמן זית', 28, '/webclient/img/mesh_items/meshulashim_pasta.png', 138),
(40, 10, 'Alfredo', 'אלפרדו', 'Stir-fried champignon mushrooms in a creamy garlic and wine sauce', 'בצל ופטריות שמפניון מוקפצים, שמנת, שום ויין לבן', 28, '/webclient/img/mesh_items/alfredo.png', 139),
(41, 10, 'Pasta Roza', 'פסטה רוזה', 'Creamy tomato sauce, seasoned with garlic and white wine', 'רוטב עגבניות שמנת שום ויין לבן', 28, '/webclient/img/mesh_items/pasta_roza.png', 140),
(42, 10, 'Arrabiata', 'ארביאטה', 'Tomato sauce, garlic, basil and olive oil', 'רוטב עגבניות שום, בזיליקום ושמן זית', 28, '/webclient/img/mesh_items/arrabiata.png', 141),
(43, 10, 'Cheese Ravioli', 'רביולי גבינה', 'In a cream sauce, seasoned with garlic and fresh basil', 'שמנת, שום, ובזיליקום טרי', 32, '/webclient/img/mesh_items/ravioli.png', 142),
(44, 10, 'Sweet Potato Ravioli', 'רביולי בטטה', 'Creamy sauce ', 'רוטב שמנת', 32, '/webclient/img/mesh_items/sweet_potato_ravioli.png', 143),
(45, 11, 'Cheese Bureka', 'בורקס גבינה', '', '', 10, '/webclient/img/mesh_items/borekas.png', 144),
(46, 11, 'Potato Bureka', 'בורקס תפו״א', '', '', 10, 'http://dev.bot2.orderapp.com/webclient/restapi/images/test.png', 145),
(47, 11, 'Deluxe Bureka', 'בורקס פינוק', 'Deluxe Borekas - tehina, tomato, pickles, harisa, hard boiled egg', 'בורקס פינוק - טחינה, עגבנייה, מלפפון, חמוץ, אריסה, ביצה קשה', 18, 'http://dev.bot2.orderapp.com/webclient/restapi/images/test.png', 146),
(48, 11, 'Edamame', 'אדממה', 'Seasoned with salt and lemon juice', 'בתיבול מלח ולימון', 15, 'http://dev.bot2.orderapp.com/webclient/restapi/images/test.png', 147),
(49, 11, 'Home Fries', 'הום פרייז', '', '', 28, '/webclient/img/mesh_items/home_fries.png', 148),
(50, 11, 'Fries', 'צ''פס', '', '', 18, '/webclient/img/mesh_items/fries.png', 149),
(51, 12, 'Coca Cola', 'קוקה קולה', '', '', 10, '/webclient/img/drinks/1-100x100.png', 150),
(52, 12, 'Coca Cola Zero', 'קוקה קולה זירו', '', '', 10, '/webclient/img/drinks/download.png', 151),
(53, 12, 'Fuze Tea', 'פיוז טה', '', '', 10, '/webclient/img/drinks/CC063.png', 152),
(54, 12, 'Prigat Grape', 'פריגת ענבים', '', '', 10, '/webclient/img/drinks/Prigan_grapefruit.png', 153),
(55, 12, 'Diet Coke', 'דייט קוקה קולה', '', '', 10, '/webclient/img/drinks/coca-cola-diet-1-75-litre.png', 154),
(56, 12, 'Sprite', 'ספרייט', '', '', 10, '/webclient/img/drinks/3-1.png', 155),
(57, 13, 'Kid''s Meal', 'ארוחת ילדים', 'Pasta in tomato sauce / toast / pizza, with cup of ''Vitaminchik'', cut vegetables', 'פסטה עגבניות / טוסט / פיצה מוגש עם כוס ויטמינצ''יק וירקות פרוסים', 25, '/webclient/img/mesh_items/kids_meal.png', 156),
(58, 14, 'Shawarma', 'שווארמה', 'Bandora Shawarma: Veal or spring chicken', 'שווארמה בנדורה: עגל/ פרגיות', 0, '/webclient/img/bandora_items/shawarma.png', 157),
(59, 14, 'Super Spicy Bandora', 'בנדורה חריף אש', 'Bandora Supreme: Pieces of veal/spring chicken shawarma, grilled onion, spicy pepper, and grilled tomatoes', 'בנדורה מחוזקת - לרציניים בלבד!! נתחי עגל/פרגית מחוזקת בטעמים על פלאנצ׳ה לוהטת בתוספת בצל, פלפל חריף אש ועגבנית צלויות על פחמים (צמרמורת!!)', 0, '/webclient/img/bandora_items/super_spicy_bandora.png', 158),
(60, 14, 'Bandura mixed grill', 'בנדורה מעורב על הגריל', 'Bandora the Barbarian''s Mixed Grill: chicken hearts, livers, sauted onion, grill spices from the Levinsky Market, and seared herbs', 'מעורב בנדורה של הברברי : לבבות, כבדים ובצל שרוף, תערובת תבלינים משוק לווינסקי ועשבי תיבול זרוקים על פחמים', 0, '/webclient/img/bandora_items/bandura_mixed_grill.png', 159),
(61, 14, 'beef kabab', 'קבב בשר', 'Kebab: a mix of ground meat with grilled vegetables', 'קבב שעושים ביד: תערובת בשר טחון של הטורקי וירקות צלויים ', 0, '/webclient/img/bandora_items/beef_kabob.png', 160),
(62, 14, 'Merguez Sausage', 'נקנקיות מרגז', 'Merguez Sausage', 'נקניקיות מרגז', 0, '/webclient/img/bandora_items/merguez_sausage.png', 161),
(63, 14, 'chicken skewers', 'שיפודי עוף', 'Jumbo Marakesh Spring Chicken Skewers: skewers spiced with harissa, cumin, hawaij, garlic, and herbs', '', 0, '/webclient/img/bandora_items/chicken_skewers.png', 162),
(64, 14, 'chicken breast', 'חזה עוף', 'Marinated Chicken Breast: chicken breast spiced with paprika, cumin, hawaij, and coarse black pepper', '', 0, '/webclient/img/bandora_items/chicken_breasts.png', 163),
(65, 15, 'Nadura Express', 'סלט נדורה', 'Bandora Express: green salad dressed with olive oil and lemon, pieces of shawarma/spring chicken/turkey strips, grilled onion, tehina, sumak, and parsley ', '', 42, '/webclient/img/bandora_items/bandora_express.png', 164),
(66, 15, 'Amami Salad', 'סלט עממי', 'Ammami Salad: green salad dressed with za''atar and lemon, pita chips, pieces of shawarma/spring chicken, grilled onion, pinenuts, and tehina', '', 42, 'http://dev.bot2.orderapp.com/webclient/restapi/images/test.png', 165),
(67, 15, 'Medura', 'מדורה', 'Medura Plate: Tomatoes, onions, hot peppers, and tehina, garnished with a sprig of parsley', '', 19, 'http://dev.bot2.orderapp.com/webclient/restapi/images/test.png', 166),
(68, 16, 'Chummus and Techina', 'חומוס עם טחינה', 'Chummus, tehina, olive oil, and pinenuts', '', 25, '/webclient/img/bandora_items/chummus_and _techina.png', 167),
(69, 16, 'Mixed meat chummus', 'חומוס עם בשר מעורב', 'Mixed Grill Chummus', '', 39, 'http://dev.bot2.orderapp.com/webclient/restapi/images/test.png', 168),
(70, 16, 'Chummus Bandora', 'חומוס בנדורה', 'Chummus Bandora', '', 39, 'http://dev.bot2.orderapp.com/webclient/restapi/images/test.png', 169),
(71, 17, 'Coca Cola', 'קוקה קולה', '', '', 10, '/webclient/img/drinks/1-100x100.png', 170),
(72, 17, 'Fuze Tea', 'פיוז טה', '', '', 10, '/webclient/img/drinks/CC063.png', 171),
(73, 17, 'Prigat Grape', 'פריגת ענבים', '', '', 10, '/webclient/img/drinks/Prigan_grapefruit.png', 172),
(74, 17, 'Coca Cola Zero', 'קוקה קולה זירו', '', '', 10, '/webclient/img/drinks/download.png', 173),
(75, 17, 'Diet Coke', 'דייט קוקה קולה', '', '', 10, '/webclient/img/drinks/coca-cola-diet-1-75-litre.png', 174),
(76, 17, 'Fanta', 'פנטה', '', '', 10, '/webclient/img/drinks/download (1).png', 175),
(77, 17, 'Large Coca Cola', 'בקבוק קוקה קולה גדול', '', '', 14, '/webclient/img/drinks/PDP_Coca-Cola-HFCS-1.25-Liter-Bottle.png', 176),
(78, 17, 'Large Fuze Tea', 'בקבוק פיוז טי גדול', '', '', 14, 'http://dev.bot2.orderapp.com/webclient/restapi/images/test.png', 177);
...
(2, 1, '/webclient/img/angus_gallery/ang_1.png'),
(3, 1, '/webclient/img/angus_gallery/ang_2.png'),
(4, 1, '/webclient/img/angus_gallery/ang_3.png'),
(5, 1, '/webclient/img/angus_gallery/ang_4.png'),
(6, 1, '/webclient/img/angus_gallery/ang_5.png'),
(7, 1, '/webclient/img/angus_gallery/ang_6.png'),
(8, 1, '/webclient/img/angus_gallery/ang_7.png'),
(9, 3, '/webclient/img/bandora_gallery/band_1.png'),
(10, 3, '/webclient/img/bandora_gallery/band_2.png'),
(11, 3, '/webclient/img/bandora_gallery/band_3.png'),
(12, 2, '/webclient/img/mesh_gallery/mesh_1.png'),
(13, 2, '/webclient/img/mesh_gallery/mesh_2.png');
